...
class Model():
    ...
    def build_model(self,dataset,nb_classes = 20):
    ...
    def train(self, dataset, batch_size = 20, np_epoch = 50, data_argumentation = True):
...
#                    height_shift_range = 0,
    ...
    MODEL_PATH = 'nacao.train.model.h5'
...
if __name__ == '__main__':
    dataset = Dataset('E:\pest1\\nacaoyzm')
    dataset.load()
    model = Model()
    model.build_model(dataset)
    model.train(dataset)
    model.save_model('nacao.train.model.h5')
    model.load_model('nacao.train.model.h5')
